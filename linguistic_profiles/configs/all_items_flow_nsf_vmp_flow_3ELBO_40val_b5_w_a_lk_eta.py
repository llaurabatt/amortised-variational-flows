...
#  4682 4685 7550 7591 7592 7593 7600 7610 7980]
  ...
  config.eta_plot = [0.001, 0.335, 1.0] #[0.001, 0.05, 0.25, 0.42, 0.5, 0.61, 0.75, 1.0]
  ...
  # FIXED 2026-08-05: previous value [10., 3., 1., 0.5, 1., 1., 0.2, 0.335] had
  # eta=0.335 in the ell_k slot and sigma_k=0.2 (should be fixed 1.0) — the 2026-07-08
  # B=5 plot suite was generated with those wrong values and must be REGENERATED
  # (two-stage: launch_plots_basis.sh then launch_plots_full.sh in the workdir).
  config.prior_hparams_plot_optim = [10., 3.,  1., 0.5, 1., 1., 1.0, 0.2]
