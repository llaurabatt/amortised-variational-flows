...
def get_config():
  ...
  # 0.315 = PMSE-tuned eta_hat; endpoints for Bayes/Cut comparison.
  # NOTE: the dump conditions on PriorHparams DEFAULTS -> when dumping, override
  # --config.kernel_kwargs.length_scale=0.2 so ell_k matches the tuned phi_hat
  # (config default 0.3 is the TRAINING default, do not change it here).
  config.eta_save = [0.001, 0.315, 1.0]
...
#  4682 4685 7550 7591 7592 7593 7600 7610 7980]
  ...
  # eta_hat=0.315 from PMSE tuning 2026-08-05 (tune_w_a_lk_eta/mean_sq_dist, RPMSE 0.297)
  config.eta_plot = [0.001, 0.315, 1.0]
  ...
  # sigma_w/sigma_a flat in tuning -> prior defaults; sigma_k FIXED at 1.0;
  # ell_k tuned to floor 0.2.
  config.prior_hparams_plot_optim = [5., 10.,  1., 0.5, 1., 1., 1.0, 0.2]
