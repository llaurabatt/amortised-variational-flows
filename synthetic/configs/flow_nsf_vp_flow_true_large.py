...
def get_config():
  ...
  config.opt_cond_hparams_values = [] # 10 groups 8 obs
  ...
  config.checkpoint_dir_comparison.opt = ''
  config.mcmc_samples_true_hparams_path = ''
  ...
  config.synth_n_groups = 50
  config.synth_n_obs = 50
...
# [0.778, 15.000][1., 1.][5.741, 15.000]
  ...
  config.prior_hparams.mu_prior_scale_s = 1.
  config.prior_hparams.sigma_prior_concentration = 0.5
  config.prior_hparams.sigma_prior_scale = 1.5
