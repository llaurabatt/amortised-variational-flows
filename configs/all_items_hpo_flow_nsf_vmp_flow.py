...
def get_config():
  ...
  config.method = 'hp_opt_vmp_flow_allhp'
  ...
  config.num_samples_hparams_optim = 2_000
...
#  4682 4685 7550 7591 7592 7593 7600 7610 7980]
  ...
  config.sweep_configuration.metric = {"goal": "minimize", "name": "minimum_mean_dist_anchor_val_min"} # f"mean_dist_anchor_val_eta{config.wandb_evaleta}"}
