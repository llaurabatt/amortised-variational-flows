...
WORK_DIR=$HOME/spatial-smi-output-integrated-allhps-mse-anchor-copies-20test20val
...
## Variational Meta-Posterior via VMP-flow
## Neural Spline Flow
python3 $REPO_DIR/main.py --config $REPO_DIR/configs/all_items_flow_nsf_vmp_flow_anchor_copies.py \
