...
import modularbayes
# from modularbayes._src.bijectors.conditional_masked_coupling_extra_all import IntegratedConditionalMaskedCoupling
...
def meta_nsf_phi(
  ...
  for _ in range(num_layers):
    layer = modularbayes.AllConditionalMaskedCoupling(
        mask=mask,
        bijector=bijector_fn,
