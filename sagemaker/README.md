...
python sagemaker/run_hpo_sm.py --config_fn='configs/all_items_flow_nsf_vmp_flow_hparam_select.py' --smi_method='vmp_flow' --log_dir $HOME/spatial-smi-output/hpo_log_20230101 --alsologtostderr &
```
