...
WORK_DIR_VP_true_small=$HOME/mount/vmp-output/synthetic/vp-true-ng10-nobs8
WORK_DIR_mcmc_true_small=$HOME/mount/vmp-output/synthetic/mcmc-ng10-nobs8
WORK_DIR_small=$HOME/mount/vmp-output/synthetic/vmp-ng10-nobs8

WORK_DIR_true_large=$HOME/mount/vmp-output/synthetic/vp-true-ng50-nobs50
WORK_DIR_mcmc_true_large=$HOME/mount/vmp-output/synthetic/mcmc-ng50-nobs50
WORK_DIR_large=$HOME/mount/vmp-output/synthetic/vmp-ng50-nobs50
...
python3 $WORK_DIR_MAIN/synthetic/main.py --config=$WORK_DIR_MAIN/synthetic/configs/flow_nsf_vp_flow_true_small.py \
...
python3 $WORK_DIR_MAIN/synthetic/main.py --config=$WORK_DIR_MAIN/synthetic/configs/flow_nsf_vmp_flow_small.py \
...
python3 $WORK_DIR_MAIN/synthetic/main.py --config=$WORK_DIR_MAIN/synthetic/configs/flow_nsf_vp_flow_true_large.py \
...
python3 $WORK_DIR_MAIN/synthetic/main.py --config=$WORK_DIR_MAIN/synthetic/configs/flow_nsf_vmp_flow_large.py \
